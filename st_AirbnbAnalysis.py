...
st.set_page_config(page_title="AirBnb-Analysis by GOWRI SHANKAR M", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    df = pd.read_csv(r"E:\Airbnb Analysis\Airbnb NYC 2019.csv", encoding="ISO-8859-1")
...
if SELECT == "Contact":
    image = Image.open("E:/Airbnb Analysis/seattle.jpg")
    st.image(image, width=300)
    Social_Media={
        "GITHUB":"https://github.com/MuYaLkuTty",
        "LINKEDIN":"https://www.linkedin.com/in/m-gowri-shankar-m-0544a8137/"}
    st.header('Airbnb Analysis')
    st.subheader(
    ...
    st.write("---")
    st.write("#")
    st.write("gowrishawn123@gmail.com")
